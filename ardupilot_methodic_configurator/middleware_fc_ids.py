...
VID_VENDOR_DICT: dict[int, list[str]] = {
    0x26AC: ["3DR"],
    0x1209: ["ArduPilot", "AET", "Airvolute", "Aocoda-RC-H743Dual", "CSKY", "GreenSight", "Japan Aviation Electronics Industry Ltd.", "mRo", "ORBITH743", "Horizon31", "Dheeran labs", "Qiotek", "Sierra Aerospace", "SkySakura"],
...
# Maps 16-bit APJ board ID to board name(s) for 298 supported boards
...
# Maps 16-bit APJ board ID to board vendor for 298 supported boards
...
# Maps 16-bit APJ board ID to MCU series for 298 supported boards
...
# Maps MCU series to 16-bit APJ board ID for 298 supported boards
