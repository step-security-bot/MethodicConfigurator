...
VID_VENDOR_DICT: dict[int, list[str]] = {
    0x1209: ["ArduPilot", "AET", "Airvolute", "Aocoda-RC-H743Dual", "CSKY", "GreenSight", "Japan Aviation Electronics Industry Ltd.", "Taiphoon", "mRo", "ORBITH743", "Horizon31", "Dheeran labs", "PrincipIoT", "Qiotek", "Sierra Aerospace", "SkySakura"],
    0x26AC: ["3DR"],
...
# Maps 16-bit APJ board ID to board name(s) for 323 supported boards
...
# Maps 16-bit APJ board ID to board vendor for 323 supported boards
...
# Maps 16-bit APJ board ID to MCU series for 323 supported boards
