...
# Maps 16-bit APJ board ID to board name(s) for 300 supported boards
...
# Maps 16-bit APJ board ID to board vendor for 300 supported boards
...
# Maps 16-bit APJ board ID to MCU series for 300 supported boards
...
# Maps MCU series to 16-bit APJ board ID for 300 supported boards
MCU_SERIES_APJ_BOARD_ID_DICT: dict[str, list[int]] = {
    ...
    "STM32L431": [1165, 1109, 1080, 6100, 1050, 5302, 1091, 1093, 1094, 5252, 5222, 1407],  # 3DR-L431-ASAUAV, AeroFox-GNSS_F9P, AeroFox-PMU, MFE_PDB_CAN, Sierra-L431, Sierra-TrueNavIC, Sierra-TrueNavPro, Sierra-TrueNorth, Sierra-TrueSpeed, TBS-L431-BattMon, TBS-L431-CurrMon, TBS-L431-PWM, uav-dev_m10s, VM-L431-BatteryTag, VM-L431-Periph-Pico, VM-L431-SRV-Hub-4CHP
