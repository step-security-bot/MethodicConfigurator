...
# Maps 16-bit APJ board ID to board name(s) for 345 supported boards
...
# Maps 16-bit APJ board ID to board vendor for 345 supported boards
APJ_BOARD_ID_VENDOR_DICT: dict[int, list[str]] = {
    ...
    6111: ["ArduPilot"],  # SVehicle-E2-mini
...
# Maps 16-bit APJ board ID to MCU series for 345 supported boards
APJ_BOARD_ID_MCU_SERIES_DICT: dict[int, list[str]] = {
    ...
    6111: ["STM32H7xx"],  # SVehicle-E2-mini
...
# Maps MCU series to 16-bit APJ board ID for 345 supported boards
