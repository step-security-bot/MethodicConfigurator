...
# Maps 16-bit APJ board ID to board name(s) for 264 supported boards
APJ_BOARD_ID_NAME_DICT: dict[int, list[str]] = {
    ...
    5222: ["uav-dev_m10s"],
    1407: ["VM-L431-Periph-Pico", "VM-L431-SRV-Hub-4CHP"],
    1151: ["VRBrain-v51"],
    1152: ["VRBrain-v52"],
    1154: ["VRBrain-v54"],
    1910: ["VRCore-v10"],
...
# Maps 16-bit APJ board ID to board vendor for 264 supported boards
APJ_BOARD_ID_VENDOR_DICT: dict[int, list[str]] = {
    ...
    1407: ["ArduPilot"],  # VM-L431-Periph-Pico, VM-L431-SRV-Hub-4CHP
...
# Maps 16-bit APJ board ID to MCU series for 264 supported boards
APJ_BOARD_ID_MCU_SERIES_DICT: dict[int, list[str]] = {
    ...
    1407: ["STM32L431"],  # VM-L431-Periph-Pico, VM-L431-SRV-Hub-4CHP
...
# Maps MCU series to 16-bit APJ board ID for 264 supported boards
MCU_SERIES_APJ_BOARD_ID_DICT: dict[str, list[int]] = {
    ...
    "STM32L431": [1109, 1080, 1050, 5302, 1091, 1093, 1094, 5252, 5222, 1407],  # AeroFox-GNSS_F9P, AeroFox-PMU, Sierra-L431, Sierra-TrueNavIC, Sierra-TrueNavPro, Sierra-TrueNorth, Sierra-TrueSpeed, TBS-L431-BattMon, TBS-L431-CurrMon, TBS-L431-PWM, uav-dev_m10s, VM-L431-Periph-Pico, VM-L431-SRV-Hub-4CHP
