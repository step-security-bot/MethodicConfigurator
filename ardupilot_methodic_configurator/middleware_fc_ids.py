...
# Maps 16-bit APJ board ID to board name(s) for 261 supported boards
...
# Maps 16-bit APJ board ID to board vendor for 261 supported boards
...
# Maps 16-bit APJ board ID to MCU series for 261 supported boards
