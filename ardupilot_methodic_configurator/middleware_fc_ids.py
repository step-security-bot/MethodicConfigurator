...
# Maps 16-bit APJ board ID to board name(s) for 258 supported boards
...
# Maps 16-bit APJ board ID to board vendor for 258 supported boards
...
# Maps 16-bit APJ board ID to MCU series for 258 supported boards
...
# Maps MCU series to 16-bit APJ board ID for 258 supported boards
MCU_SERIES_APJ_BOARD_ID_DICT: dict[str, list[int]] = {
    ...
    "STM32L431": [1109, 1080, 1050, 5302, 1091, 1093, 1094, 5252, 5222],  # AeroFox-GNSS_F9P, AeroFox-PMU, Sierra-L431, Sierra-TrueNavIC, Sierra-TrueNavPro, Sierra-TrueNorth, Sierra-TrueSpeed, TBS-L431-BattMon, TBS-L431-CurrMon, TBS-L431-PWM, uav-dev_m10s
